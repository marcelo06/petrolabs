...
<div class="contentPane">
	<form id="modulesForm" name="modulesForm" action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
		...
		<input type="hidden" name="oldContent" value="<?= $conf['modules']->content ? 'TRUE' : 'FALSE' ?>" />
		<input type="hidden" name="oldPages" value="<?= $conf['modules']->pages ? 'TRUE' : 'FALSE' ?>" />
		<input type="hidden" name="oldSubpages" value="<?= $conf['modules']->subpages ? 'TRUE' : 'FALSE' ?>" />
		<input type="hidden" name="oldImages" value="<?= $conf['modules']->images ? 'TRUE' : 'FALSE' ?>" />
		<table class="formTable">
			<tr>
				<th>Contenidos:</th>
				<td><input type="checkbox" name="content" value="1"<? if($conf['modules']->content) echo " checked"; ?>></td>
				<td width="50"></td>
				<th>Páginas:</th>
				<td><input type="checkbox" name="pages" value="1"<? if($conf['modules']->pages) echo " checked"; ?>></td>
				<td width="50"></td>
				<th>Sub-páginas:</th>
				<td><input type="checkbox" name="subpages" value="1"<? if($conf['modules']->subpages) echo " checked"; ?>></td>
				<td width="50"></td>
				<th>Gestor de imágenes:</th>
				<td><input type="checkbox" name="images" value="1"<? if($conf['modules']->images) echo " checked"; ?>></td>
				<td width="20"></td>
...
<div class="contentPane">
	<form id="sliderForm" name="sliderForm" action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
		...
		<input type="hidden" name="oldSliderImgMaxNum" value="<?= $conf['modules']->sliderImgMaxNum ?>">
		<input type="hidden" name="oldSliderImgWidth" value="<?= $conf['modules']->sliderImgWidth ?>">
		<input type="hidden" name="oldSliderImgHeight" value="<?= $conf['modules']->sliderImgHeight ?>">
		<input type="hidden" name="oldSliderImgDesc" value="<?= $conf['modules']->sliderImgDesc ? 'TRUE' : 'FALSE' ?>">
		<table class="formTable">
			<tr>
				<th>Límite de imágenes:</th>
				<td><input type="text" name="sliderImgMaxNum" value="<?= $conf['modules']->sliderImgMaxNum ?>" size="45"></td>
			</tr>
			<tr>
				<th>Tamaño de las imágenes:</th>
				<td>
					<input type="text" name="sliderImgWidth" value="<?= $conf['modules']->sliderImgWidth ?>" size="10"> x
					<input type="text" name="sliderImgHeight" value="<?= $conf['modules']->sliderImgHeight ?>" size="10">
				</td>
			</tr>
			<tr>
				...
				<td>
					<select name="sliderImgDesc">
						...
						<option value="TRUE"<? if($conf['modules']->sliderImgDesc) echo " selected"; ?>>Si</option>
					</select>
				</td>
			</tr>
			<tr>
...
<form id="languagesForm" name="languagesForm" action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
	...
	<input type="hidden" name="oldHowDisplayLang" value="<?= $conf['modules']->howDisplayLang ?>" />
	<header class="marginT35px">
		...
		<div class="fRight">
			...
			<select name="howDisplayLang">
				...
				<option value="abbreviation"<? if($conf['modules']->howDisplayLang=='abbreviation') echo " selected"; ?>>Abreviatura</option>
				<option value="image"<? if($conf['modules']->howDisplayLang=='image') echo " selected"; ?>>Imagen</option>
			</select>
		</div>
		<div class="clear"></div>
	</header>
