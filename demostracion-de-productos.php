...
<div class=" whiteBg">
	<section class="centerContent">
		<div id="breadCrumbs">
			<div id="breadNav"><a href="index.php"><?= INICIO ?></a> &raquo; <a href="productos.php"><?= PRODUCTOS ?></a> &raquo; <?= $pageTitle;?></div>
		...
		<div id="videosPage"><?
			for($i=0; $i<$numTxt; $i++)
			{
				...
				<div class="videoContainer">
					<iframe width="440" height="248" src="//www.youtube.com/embed/<?= youtube_id_from_url($videoUrl); ?>?rel=0&autohide=1&showinfo=0" frameborder="0" allowfullscreen></iframe>
				</div><?				
			}?>		
		</div>
		<div class="clear"></div>			
